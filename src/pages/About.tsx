...
const About = () => {
  ...
  return (
    <div style={{ fontFamily: "'Segoe UI', sans-serif", background: "#ffffff", color: "#0f172a" }}>
      ...
      {/* ── HERO ── */}
      <section style={{ background: "#1e3a35", padding: isMobile ? "24px 0 28px" : "30px 0 32px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: isMobile ? "0 16px" : "0 32px", textAlign: "center", position: "relative", zIndex: 2 }}>
          ...
          <p style={{ fontSize: isMobile ? 22 : 32, fontWeight: 900, color: "black", letterSpacing: isMobile ? "1px" : "3px", textTransform: "uppercase", marginBottom: 6, textAlign: "center" }}>
            About Us
          </p>

          <a href={MAPS_URL} target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none", display: "inline-block", marginBottom: 12 }}>
            <div
              style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.15)", borderRadius: 30, padding: isMobile ? "4px 12px" : "5px 16px", cursor: "pointer", transition: "background 0.2s, border-color 0.2s" }}
            ...
            >
              <MapPin size={isMobile ? 18 : 23} color="#c9953a" />
              <span style={{ fontSize: isMobile ? 14 : 20, fontWeight: 700, letterSpacing: isMobile ? "1px" : "2px", textTransform: "uppercase", color: "black" }}>Anna Nagar, Chennai</span>
            </div>
          </a>

          <h1 style={{ fontSize: isMobile ? "28px" : "clamp(36px, 5vw, 64px)", fontWeight: 900, color: "black", lineHeight: 1.08, letterSpacing: isMobile ? "-1px" : "-2px", marginBottom: 12 }}>
            We Build Careers,{" "}
            <span style={{ color: "#93c5fd" }}>Not Just Résumés.</span>
          </h1>

          <p style={{ fontSize: isMobile ? 15 : 20, color: "#1a1a1a", lineHeight: 1.8, marginBottom: 28, maxWidth: 900, margin: "0 auto 32px auto", fontWeight: 500 }}>
            ...
            {stats.map((s, i) => (
              <div key={i} style={{
                ...
                borderRight: isMobile
                  ? (i % 2 === 0 ? "2px solid rgba(0,0,0,0.8)" : "none")
                  : (i < 3 ? "2px solid rgba(0,0,0,0.8)" : "none"),
                borderBottom: isMobile && i < 2 ? "2px solid rgba(0,0,0,0.8)" : "none",
              }}>
                <div style={{ fontSize: isMobile ? 24 : 32, fontWeight: 900, color: "#000000", letterSpacing: "-1px", marginBottom: 4 }}>
                  <CountUp target={s.value} suffix={s.suffix} />
                </div>
                <div style={{ fontSize: isMobile ? 11 : 18, color: "white", textTransform: "uppercase", letterSpacing: isMobile ? "0.5px" : "1.5px", fontWeight: 800 }}>{s.label}</div>
              </div>
            ))}
          </div>
      ...
      {/* ── WHO WE ARE ── */}
      <section style={{ padding: isMobile ? "40px 0" : "80px 0", background: "#ffffff" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: isMobile ? "0 16px" : "0 32px" }}>
          <p style={{ fontSize: isMobile ? 28 : 45, fontWeight: 700, color: "#1e3a35", letterSpacing: isMobile ? "1px" : "2.5px", textTransform: "uppercase", marginBottom: 12, textAlign: "center" }}>Who We Are</p>
          <div style={{
            display: "grid",
            ...
            <div>
              <h2 style={{ fontSize: isMobile ? 28 : 65, fontWeight: 1000, color: "#0f172a", letterSpacing: isMobile ? "-0.5px" : "-1.5px", marginBottom: 20, lineHeight: 1.1, marginTop: isMobile ? 0 : 100 }}>
                Chennai's Premier IT & Non-IT Training Institute
              </h2>
            </div>
            <div style={{ maxWidth: 900 }}>
              <p style={{ fontSize: isMobile ? 15 : 17, color: "#4a5568", lineHeight: 1.9, marginBottom: 20, letterSpacing: "0.01em" }}>
              ...
              <p style={{ fontSize: isMobile ? 15 : 17, color: "#4a5568", lineHeight: 1.9, letterSpacing: "0.01em" }}>
      ...
      {/* ── MISSION & VISION ── */}
      <section style={{ padding: isMobile ? "40px 0" : "80px 0", background: "#f0f7f5" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: isMobile ? "0 16px" : "0 32px" }}>
          <div style={{ textAlign: "center", marginBottom: isMobile ? 28 : 56 }}>
            <p style={{ fontSize: isMobile ? 28 : 45, fontWeight: 700, color: "#1e3a35", letterSpacing: isMobile ? "1px" : "2.5px", textTransform: "uppercase", marginBottom: 12, textAlign: "center" }}>What Drives Us</p>
            <h2 style={{ fontSize: isMobile ? 22 : 36, fontWeight: 900, color: "#0f172a", letterSpacing: "-1.5px", margin: 0 }}>Mission & Vision</h2>
          </div>
          ...
          <div style={{
            ...
            <div style={{ background: "#1e3a35", borderRadius: 20, padding: isMobile ? "28px 20px" : "48px 40px", position: "relative", overflow: "hidden" }}>
              ...
              <p style={{ fontSize: isMobile ? 16 : 20, fontWeight: 900, color: "#93c5fd", letterSpacing: "2px", textTransform: "uppercase", marginBottom: 12 }}>Our Mission</p>
              <h3 style={{ fontSize: isMobile ? 18 : 22, fontWeight: 700, color: "white", lineHeight: 1.3, marginBottom: 16, letterSpacing: "-0.5px" }}>
                Empowering students with practical and affordable education.
              </h3>
              <p style={{ fontSize: isMobile ? 15 : 18, color: "rgba(255,255,255,0.6)", lineHeight: 1.85, fontWeight: 300, margin: 0 }}>
            ...
            <div style={{ background: "white", border: "1.5px solid #e2e8f0", borderRadius: 20, padding: isMobile ? "28px 20px" : "48px 40px" }}>
              ...
              <p style={{ fontSize: isMobile ? 16 : 20, fontWeight: 900, color: "#1e3a35", letterSpacing: "2px", textTransform: "uppercase", marginBottom: 12 }}>Our Vision</p>
              <h3 style={{ fontSize: isMobile ? 18 : 22, fontWeight: 700, color: "#0f172a", lineHeight: 1.3, marginBottom: 16, letterSpacing: "-0.5px" }}>
                Becoming a leading institute for skill-based education and placements.
              </h3>
              <p style={{ fontSize: isMobile ? 15 : 19, color: "#64748b", lineHeight: 1.85, margin: 0 }}>
          ...
          <div style={{
            ...
            {[
              ...
              <div key={i} style={{ background: "white", border: "1.5px solid #e2e8f0", borderRadius: 14, padding: isMobile ? "16px 14px" : "22px 20px", transition: "all 0.2s", cursor: "default" }}
                ...
                <div style={{ fontSize: isMobile ? 18 : 20, marginBottom: 8 }}>{v.icon}</div>
                <div style={{ fontSize: isMobile ? 14 : 20, fontWeight: 700, color: "#0f172a", marginBottom: 4 }}>{v.title}</div>
                <div style={{ fontSize: isMobile ? 13 : 15, color: "#64748b", lineHeight: 1.5 }}>{v.desc}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ padding: isMobile ? "36px 0" : "64px 0", background: "#ffffff", borderTop: "1px solid #e2e8f0" }}>
        <div style={{
          ...
          <div>
            <h3 style={{ fontSize: isMobile ? 22 : 30, fontWeight: 700, color: "#0f172a", letterSpacing: "-0.5px", marginBottom: 6 }}>Ready to start your journey?</h3>
            <p style={{ fontSize: isMobile ? 15 : 20, color: "#64748b", margin: 0 }}>Book a free demo class — no commitment, no pressure.</p>
          </div>
          <div style={{ display: "flex", gap: 12, width: isMobile ? "100%" : "auto" }}>
            <Link to="/contact" style={{ flex: isMobile ? 1 : "unset" }}>
              <button style={{ width: isMobile ? "100%" : "auto", background: "#1e3a35", color: "white", border: "none", padding: isMobile ? "12px 16px" : "13px 28px", borderRadius: 8, fontSize: isMobile ? 15 : 18, fontWeight: 700, cursor: "pointer", display: "inline-flex", alignItems: "center", justifyContent: "center", gap: 8, transition: "background 0.2s" }}
            ...
            <Link to="/courses" style={{ flex: isMobile ? 1 : "unset" }}>
              <button style={{ width: isMobile ? "100%" : "auto", background: "transparent", color: "#1e3a35", border: "1.5px solid #a7c4bc", padding: isMobile ? "12px 16px" : "13px 28px", borderRadius: 8, fontSize: isMobile ? 15 : 18, fontWeight: 700, cursor: "pointer" }}>
                Browse Courses
              </button>
            </Link>
          </div>
